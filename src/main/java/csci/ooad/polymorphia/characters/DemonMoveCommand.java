...
public class DemonMoveCommand implements Command {
    private static final Logger logger = LoggerFactory.getLogger(DemonMoveCommand.class);
    Creature character;
    static final Double HEALTH_LOST_IN_MOVING_ROOMS = 0.25;
    public DemonMoveCommand(Creature character) {
