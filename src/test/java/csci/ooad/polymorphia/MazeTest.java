...
class MazeTest {
    ...
    void testHasLivingAdventurers() {
        ...
        maze.addToRandomRoom(characterFactory.createAdventurer("Arwen"));
    ...
    void testHasLivingCreatures() {
        ...
        maze.addToRandomRoom(characterFactory.createCreature("Dragon"));
    ...
    void testIndividualRoomCreation() throws NoSuchRoomException {
        Adventurer adventure = characterFactory.createAdventurer("Frodo");
